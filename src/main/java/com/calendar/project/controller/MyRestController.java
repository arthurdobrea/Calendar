...
public class MyRestController {
    ...
    public @ResponseBody
    void createEvent(@RequestBody EventResource eventResource) {
    ...
    public @ResponseBody
    ResponseEntity updateEvent(@PathVariable @RequestParam("id") int id, @RequestBody EventResource eventResource) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public @ResponseBody
    ResponseEntity deleteEvent(@PathVariable @RequestParam("id") int id) {
        User user = securityService.findLoggedInUsername();
    ...
    @ResponseStatus(HttpStatus.OK)
    public @ResponseBody
    ResponseEntity editUser(@PathVariable @RequestParam("username") String username, @RequestBody UserDTO userDTO) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public @ResponseBody
    void createUser(@RequestBody UserDTO userDTO) throws IOException {
    ...
    @ResponseStatus(HttpStatus.OK)
    public @ResponseBody
    ResponseEntity deleteUser(@PathVariable @RequestParam("username") String username) throws IOException {
        User user1 = securityService.findLoggedInUsername();
        User firstUser = userService.findByUsername(username);
