...
<div class="generic-container" style="width: 1450px; margin-top: 5%; max-width: 100%; max-height: 100%">
    <div class="panel panel-default box_style_shadow"
        ...
        <table id="id" class="table table-hover" style="padding-left: 300px; max-width: 100%; max-height: 100%">
            ...
            <th style="border: none; max-width: 100%; max-height: 100%"><input type="text" id="w-input-search-username"
                                                                               onkeyup="searchFunction()" value=""
                                                                               placeholder="By username"
                                                                               class="user_button_style"></th>
            <th style="border: none; max-width: 100%; max-height: 100%"><input type="text" id="w-input-search-firstname"
                                                                               onkeyup="searchFunction2()" value=""
                                                                               placeholder="By first name"
                                                                               class="first_name_button_style"></th>
            <th style="border: none; max-width: 100%; max-height: 100%"><input type="text" id="w-input-search-lastname"
                                                                               onkeyup="searchFunction3()" value=""
                                                                               placeholder="By last name"
                                                                               class="last_name_button_style"></th>
            <th style="border: none; max-width: 100%; max-height: 100%"><input type="text" id="w-input-search-email"
                                                                               onkeyup="searchFunction4()" value=""
                                                                               placeholder="By email"
                                                                               class="email_button_style"></th>
            <th style="border: none; max-width: 100%; max-height: 100%"><input type="text"
                                                                               id="w-input-search-assignment_name"
                                                                               value=""
                                                                               placeholder="By assignment"
                                                                               class="assignment_button_style"></th>
            <th style="border: none; max-width: 100%; max-height: 100%"><select id="w-input-search-role"
                                                                                onchange="searchFunction6()"
                                                                                class="roles_button_style">
    ...
    <div class="panel panel-default box_style_shadow"
         style="padding-left: 30px; padding-right: 30px; padding-bottom: 30px; max-width: 100%; max-height: 100%">

        <table id="administrationTable" class="table table-hover"
                ...
                <td style="width: 90px; padding-top: 15px">
                    ...
                    <c:if test="${pageContext.request.isUserInRole('ADMIN')}">
                        ...
                        <c:if test="${not fn:contains({user.roles}, 'ROLE_SUPREME_ADMIN')}">
                            <button type="button" class="btn_edit_image" data-toggle="modal" data-target="#myModal_edit"
                                    id="${user.username}"></button>
                        </c:if>
                    </c:if>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <c:if test="${pageContext.request.isUserInRole('SUPREME_ADMIN')}">
                                <button type="deleteButton" class="btn_delete_image" data-toggle="modal"
                                        data-target="#myModal"
                                        id="${user.username}"></button>
                            </c:if>
                        </c:otherwise>
    ...
    <div class="modal-dialog" style="padding-top: 25%; padding-bottom: 25%;padding-left: 11%;padding-right: 25%">
        ...
        <div class="modal-content" style="width: 400px; border-radius: 0px; padding-bottom: 37px">
            <div class="modal_content">
                <button type="button" style="margin-top: 0%" class="btn_close_modal" data-dismiss="modal"></button>
                ...
                <div style="padding-top: 30px">
                    <button type="button" class="btn_not_today_modal" data-dismiss="modal">NOT TODAY</button>
                </div>
        ...
        <div class="modal-content" style="width: 600px; border-radius: 0px; padding-bottom: 37px">
            <div id="modal-content" class="modal_content">
                ...
                <form id="edit-form" name="form">
                    ...
                    <input type="hidden" id="idOfUser" data-id="id"
                           class="form-control class_for_submit111 modal_window_fields_admin" placeholder="ID"/>
                    <input type="hidden" id="username" data-id="username"
                           class="form-control modal_window_fields_admin class_for_submit111" placeholder="Username"/>
                    <input type="hidden" id="email" data-id="email"
                           class="form-control modal_window_fields_admin class_for_submit111" placeholder="Email"/>
                    <div>
                        <input type="text" id="firstname" data-id="firstname" name="firstname"
                               data-validetta="required,minLength[2],maxLength[20],regExp[example]"
                               class="form-control modal_window_fields_admin class_for_submit111"
                               placeholder="First name"/>
                    </div>
                    <input type="text" id="lastname" data-id="lastname"
                           data-validetta="required,minLength[2],maxLength[20],regExp[example]"
                           class="form-control modal_window_fields_admin class_for_submit111" placeholder="Last name"/>
                    <input type="text" id="position" data-id="position"
                           data-validetta="required,minLength[2],maxLength[20],regExp[fields]"
                           class="form-control modal_window_fields_admin class_for_submit111" placeholder="Position"/>
                    <select type="select" id="roles" data-id="roles"
                            class="modal_window_select_box_admin class_for_submit111" style="padding-left: 5px;">
