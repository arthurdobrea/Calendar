    ...
    <div class="modal-dialog" align="center" style="margin-top: 15%">
        ...
        <div class="row delete_event_modal">
            <div class="modal-header delete_event_header endava_grey_text">
                <div align="left" class="modal_topic">DELETE EVENT
            ...
            <div class="delete_event_body">
                <form:form method="POST" modelAttribute="eventForm">
                    <div class="for_delete_event endava_grey_text" style="float: left;">Are you sure you want to delete
                        this event?
                    </div>
                    <spring:bind path="id">
                        <div class="form-group ${status.error ? 'has-error' : ''}">
                            ...
                            <div class=" col-sm-12" style="padding: 0">
                                <button class="btn_delete_event_cancel" data-dismiss="modal" style="float: left">NOT
                                    TODAY
                                </button>
                                <button class="btn_delete_event_submit" type="submit" style="float: right">DELETE
                                </button>
                            </div>
                        </div>
                    </spring:bind>
