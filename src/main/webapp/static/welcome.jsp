...
<table class="greeting-wrapper">
    ...
    <tr>
        <td class="greeting_4">
            <a onclick="create_event()" data-toggle="modal" data-toggle="#AddEvent" class="greeting-btn endava_grey_text">ADD EVENT</a>
            <a href="events" class="greeting-btn endava_grey_text">SEE EVENTS</a>
        </td>
    </tr>
</table>
