            ...
            <div class="modal-body">
                <form:form method="POST" action="${contextPath}/index" modelAttribute="eventForm" class="form-signin">
                    ...
                    <spring:bind path="description">
                        <div class="form-group ${status.error ? 'has-error' : ''}">
                            <form:textarea type="textarea" rows="7" path="description" class="form-control"
                    ...
                    <spring:bind path="participants">
                        <div class="form-group ${status.error ? 'has-error' : ''}">
                            <form:select path="participants" cssClass="form-control" itemLabel="fullName" itemValue="id"
                                         items="${eventForm.participants}"
                    ...
                    <spring:bind path="tags">
                        <div class="form-group ${status.error ? 'has-error' : ''}">
                            <form:select path="tags" cssClass="form-control" itemValue="id" itemLabel="tag"
                                         items="${eventForm.tags}"
                                         multiple="true" required="true"/>
                        </div>
                    </spring:bind>


                    Send emails to participans <input type="checkbox" name="checkParticipants" checked/>
                    Send emails to subscribers <input type="checkbox" name="checkSubscribe" checked/>
