                        ...
                        <div class="row" id="leftblock" style="padding-right: 15px">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" id="ev-title" placeholder="Enter title" >
                                </div>
                                <div class="form-group">
                                    <label for="ev-location">LOCATION</label>
                                    <input type="text"  name="location" class="form-control" id="ev-location" placeholder="Enter Location">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date"  name="start" class="form-control" id="ev-start-date" placeholder="Choose date... ">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="ev-end-date">END DATE</label>
                                            <input type="date" name="end" class="form-control" id="ev-end-date" placeholder="Choose date... ">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row" id="rightblock">
                                <div class="col-sm-6">
                                    <div class="form-group textarea-group">
                                        ...
                                        <textarea name="description" class="form-control" rows="3" id="ev-description"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                ...
                                <div class="checkbox-group"  style="text-align: center" id="tag-checkbox">
                                    <c:forEach items="${tags}" var="tag">
                                        <label class="checkbox-inline" style="color:${tag.tag.color()}">
                                            <input type="checkbox" name="checkboxTags" id="checkboxTag" > ${tag.tag.view()}
                                        </label>
                                    </c:forEach>
